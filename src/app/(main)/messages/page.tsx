  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-headline font-bold text-foreground">Tin nhắn</h1>
          <p className="text-sm text-muted-foreground">Chia sẻ chiến thuật với cộng đồng</p>
        </div>
      ...
      {!isLoading && (
        <div className="space-y-2">
          {filteredConversations.length === 0 ? (
            <div className="text-center py-12 bg-panel rounded-xl border border-white/5">
              <MessageSquare className="w-12 h-12 text-muted-foreground mx-auto mb-4" />
              <h3 className="font-semibold text-foreground mb-2">Chưa có tin nhắn</h3>
